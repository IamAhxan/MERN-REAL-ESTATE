            ...
            <div className="p-7 border-b-2 sm:border-r-2 md:min-h-screen">
                <form onSubmit={handleSubmit} className='flex flex-col gap-8'>
                    <div className="flex items-center gap-2">
                        <label htmlFor="searchTerms" className="whitespace-nowrap">Search Term:</label>
                    ...
                    <div className="flex gap-2 flex-wrap items-center">
                        ...
                        <div className='flex items-center gap-2'>
                            ...
                            <select
                                ...
                                <option value='regularPrice_desc'>Prices: High to Low</option>
                                <option value='regularPrice_asc'>Prices: Low to High</option>
